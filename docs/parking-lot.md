...
- **🔴 `master-spec.md` FULL REGENERATION — DEFERRED TWICE, FIRST IN QUEUE.** Six 07-30 decisions override its current lines, including a pinned ⚠️ that was superseded. **jAIne has read ~200 of 669 lines across two sessions and has twice declined to fake it.** Dedicated session, no build work alongside.
